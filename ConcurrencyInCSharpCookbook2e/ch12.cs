...
public class ch12r00B
{
    ...
    public async Task<int> ModifyValueConcurrentlyAsync()
    {
        ...
        Task task4 = ModifyValueAsync(data);
        Task task5 = ModifyValueAsync(data);
        Task task6 = ModifyValueAsync(data);
        Task task7 = ModifyValueAsync(data);
...
public class ch12r00C
{
    ...
    public async Task<int> ModifyValueConcurrentlyAsync()
    {
        ...
        Task task4 = ModifyValueAsync();
        Task task5 = ModifyValueAsync();
        Task task6 = ModifyValueAsync();
        Task task7 = ModifyValueAsync();
